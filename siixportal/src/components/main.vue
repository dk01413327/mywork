            ...
            <el-container>
                <el-header class="page-header" >
                    <el-row type="flex" align="middle" >
                        ...
                        <el-col :offset="21" :span="2" class="nav-user">
                            <el-dropdown placement="bottom" trigger="click" @command="handleDropDown">
                                <span class="user-text">
                                    <img src='/static/images/user.png' style="width:40px;height:40px">
                                    {{userinfo.emp_name}}</span>                            
...
export default {
    ...
    methods:{
        ...
        changePassword(){
            ...
            var data ='passwd='+this.oldpw+'&newpassword='+this.newpw1+'&empno='+this.userinfo.emp_no;
            var _this = this;
...
window.onresize = function(){$('#wrapper').css('height',window.innerHeight);}
</script>
<style scoped>
    .logo{
        height: 60px;
